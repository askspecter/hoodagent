...
func streamWithReconnect(ctx context.Context, provider Provider, request holtruntime.CompletionRequest, notify reconnectNotifier) (<-chan holtruntime.StreamEvent, error) {
