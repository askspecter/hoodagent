...
func MeasureContext(messages []holtruntime.Message, tools []holtruntime.ToolDefinition, contextWindow int) ContextBreakdown {
	systemEnd := 0
...
func estimateToolTokens(tools []holtruntime.ToolDefinition) int {
	total := 0
