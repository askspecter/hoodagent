...
func TestMeasureContextSplitsByCategory(t *testing.T) {
	messages := []holtruntime.Message{
		{Role: holtruntime.MessageRoleSystem, Content: filler(2000)},
		{Role: holtruntime.MessageRoleUser, Content: filler(400)},
		{Role: holtruntime.MessageRoleAssistant, Content: filler(400)},
	}
...
func TestMeasureContextUnknownWindowHasZeroFraction(t *testing.T) {
	breakdown := MeasureContext([]holtruntime.Message{
