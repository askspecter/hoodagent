...
func (p *flakyProvider) StreamCompletion(_ context.Context, _ holtruntime.CompletionRequest) (<-chan holtruntime.StreamEvent, error) {
...
func TestStreamWithReconnectRecoversFromTransientDisconnect(t *testing.T) {
	...
	stream, err := streamWithReconnect(context.Background(), p, holtruntime.CompletionRequest{}, nil)
	if err != nil {
...
func TestStreamWithReconnectGivesUpAfterMax(t *testing.T) {
	...
	_, err := streamWithReconnect(context.Background(), p, holtruntime.CompletionRequest{}, nil)
	if err == nil {
...
func TestStreamWithReconnectStopsOnContextCancel(t *testing.T) {
	...
	_, err := streamWithReconnect(ctx, p, holtruntime.CompletionRequest{}, nil)
	if err == nil {
