...
import (
	...
	"github.com/askspecter/holt/internal/repomap"
	"github.com/askspecter/holt/internal/workspaceseed"
)
...
const fallbackSystemPrompt = "You are Holt, a terminal coding agent. Help with the current workspace and use tools when needed."
...
var projectContextFiles = []string{"AGENTS.md", "HOLT.md", ".holt/AGENTS.md"}
