// Package oauth is holt's reusable OAuth 2.0 engine. It generalizes the
...
// HOLT_OAUTH_ALLOW_PRESETS is set; env always overrides a preset.
package oauth
...
// A holt ExpiresAt means "no known expiry" and is treated as not expired.
