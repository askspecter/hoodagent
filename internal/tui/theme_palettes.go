...
// terminal page, which Holt never paints) with near-black ink and an olive-lime
...
// themeEntry is one registered theme: Name is the /theme value + HOLT_THEME/--theme
