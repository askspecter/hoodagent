...
const workerPrompt = `You are a focused task specialist inside Holt.
...
const explorerPrompt = `You are a read-only codebase exploration specialist inside Holt.
...
const codeReviewPrompt = `You are a code review specialist inside Holt.
