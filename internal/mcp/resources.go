...
import (
	...
	"github.com/askspecter/holt/internal/workspaceindex"
)
...
// the fields HOLT populates are emitted; pagination cursors and icons are not
// used.
...
// binary extensions, ...) match the rest of HOLT instead of re-walking.
