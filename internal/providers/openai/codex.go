...
type CodexOptions struct {
	...
	// / "holt" branded value is recommended.
	UserAgent string
...
func NewCodexProvider(options CodexOptions) (*CodexProvider, error) {
	...
	if userAgent == "" {
		// Default to the openai Options.UserAgent (typically "holt/<ver>")
...
func (p *CodexProvider) StreamCompletion(ctx context.Context, request holtruntime.CompletionRequest) (<-chan holtruntime.StreamEvent, error) {
