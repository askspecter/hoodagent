...
// Cleanup releases any resources the plan holds. It is safe to call on a holt
...
func (engine *Engine) BuildCommandPlan(spec CommandSpec) (CommandPlan, error) {
	...
	// HOLT_SANDBOXED=1 and HOLT_SANDBOX_BACKEND set in its env — see
...
// `log stream`.
const sandboxDenialLogTag = "holt-sandbox-denied-v1"
