...
const LinuxSandboxHelperName = "holt-linux-sandbox"
...
func linuxHelperSandboxEnvironmentOverrides(profile PermissionProfile) []string {
	return []string{
		...
		"HOLT_SANDBOX_NETWORK=" + string(profile.Network.Mode),
		EnvSandboxed + "=1",
	}
}
...
func findLinuxSandboxHelperCommand() (LinuxSandboxHelperCommand, error) {
	...
	return LinuxSandboxHelperCommand{}, errors.New("holt-linux-sandbox helper is not available")
}
