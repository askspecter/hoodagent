...
func (registry Registry) EstimateCost(pattern string, usage holtruntime.Usage) (CostBreakdown, error) {
...
func CalculateCost(model ModelEntry, usage holtruntime.Usage) (CostBreakdown, error) {
