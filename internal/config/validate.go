...
// ValidateFile reads and parses path as a Holt FileConfig and runs the same
...
// ValidateBytes parses data as a Holt FileConfig and runs the same semantic
// provider/model rules as ValidateFile. It returns the parsed config (holt
