...
func TestNewBackendDoctorReportSurfacesDiagnosticsAndActions(t *testing.T) {
	...
	assertBackendDoctorCheck(t, report, "backend.mcp.server", "remote", BackendDoctorStatusPass, "holt mcp check remote")
	assertBackendDoctorCheck(t, report, "backend.mcp.invalid", "broken", BackendDoctorStatusFail, "holt mcp add broken")
	assertBackendDoctorCheck(t, report, "backend.mcp.disabled", "disabled", BackendDoctorStatusWarn, "holt mcp enable disabled")
	assertBackendDoctorCheck(t, report, "backend.hooks.disabled", "hooks", BackendDoctorStatusWarn, "holt hooks list")
	assertBackendDoctorCheck(t, report, "backend.hooks.diagnostic", "holt.preflight-[REDACTED]", BackendDoctorStatusFail, "holt hooks list")
	assertBackendDoctorCheck(t, report, "backend.plugins.disabled", "holt.docs", BackendDoctorStatusWarn, "holt plugins list")
	assertBackendDoctorCheck(t, report, "backend.plugins.diagnostic", "holt.docs-[REDACTED]", BackendDoctorStatusWarn, "holt plugins list")
...
func TestNewBackendDoctorReportPassesEmptySetup(t *testing.T) {
	...
	assertBackendDoctorCheck(t, report, "backend.mcp.configured", "mcp", BackendDoctorStatusPass, "holt mcp add")
	assertBackendDoctorCheck(t, report, "backend.hooks.configured", "hooks", BackendDoctorStatusPass, "holt hooks list")
	assertBackendDoctorCheck(t, report, "backend.plugins.configured", "plugins", BackendDoctorStatusPass, "holt plugins list")
}
