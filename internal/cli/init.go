...
import (
	...
	"github.com/askspecter/holt/internal/agentinit"
)

// runInit implements `holt init`: investigate the repo and generate an
...
const initHelp = `holt init — investigate the repository and generate an AGENTS.md.
...
Usage:
  holt init [exec flags]

Accepts the same flags as 'holt exec' (e.g. --model, -w/--worktree, --add-dir).
`
