...
import (
	...
	"github.com/askspecter/holt/internal/repoinfo"
)

// BuildPrompt returns the bootstrap prompt for `holt init` / `/init`. It runs
...
// injectable for tests; holt falls back to time.Now.
