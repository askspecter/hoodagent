...
Holt is a terminal coding agent: it reads and edits files in your repository and can run shell
...
- Findings that require a malicious local user who already controls the machine running Holt, or that
...
- Holt sends no telemetry. Network calls go to the model/tool providers you configure (and, for
